...
(check-expect (render-ball (make-ball RIG BOT 0 0))
              (place-image BALL RIG BOT MTS))


; (define (render-ball b) MTS) ; stub

(@template-origin Ball)
(@template (define (render-ball b)
             (... (ball-x b) 
                  (ball-y b) 
                  (ball-dx b) 
                  (ball-dy b))))
...
(check-expect (touch-bottom? (make-ball LEF (- BOT 1) 0 0)) false)
(check-expect (touch-bottom? (make-ball LEF (- BOT 1) 0 1)) true)
(check-expect (touch-bottom? (make-ball LEF (- BOT 1) 0 2)) true)
(check-expect (touch-bottom? (make-ball LEF    BOT    0 0)) true)
(check-expect (touch-bottom? (make-ball LEF (+ BOT 1) 0 0)) true)

; (define (touch-bottom? b) false) ; stub

(@template-origin Ball)
(@template (define (touch-bottom? b)
             (... (ball-x b) 
                  (ball-y b) 
                  (ball-dx b) 
                  (ball-dy b))))
...
(check-expect (touch-left? (make-ball (- LEF 1) TOP 0 0)) true)
(check-expect (touch-left? (make-ball    LEF    TOP 0 0)) true)
(check-expect (touch-left? (make-ball (+ LEF 1) TOP 0 0)) false)
(check-expect (touch-left? (make-ball (+ LEF 1) TOP -1 0)) true)
(check-expect (touch-left? (make-ball (+ LEF 1) TOP -2 0)) true)

; (define (touch-left? b) false) ; stub

(@template-origin Ball)
(@template (define (touch-left? b)
             (... (ball-x b) 
                  (ball-y b) 
                  (ball-dx b) 
                  (ball-dy b))))
...
(check-expect (touch-right? (make-ball (- RIG 1) TOP 0 0)) false)
(check-expect (touch-right? (make-ball (- RIG 1) TOP 1 0)) true)
(check-expect (touch-right? (make-ball (- RIG 1) TOP 2 0)) true)
(check-expect (touch-right? (make-ball    RIG    TOP 0 0)) true)
(check-expect (touch-right? (make-ball (+ RIG 1) TOP 0 0)) true)

; (define (touch-right? b) false) ; stub

(@template-origin Ball)
(@template (define (touch-right? b)
             (... (ball-x b) 
                  (ball-y b) 
                  (ball-dx b) 
                  (ball-dy b))))
...
(check-expect (bounce-bottom (make-ball LEF (- BOT 3) 2 4))
              (make-ball LEF (- BOT 1) 2 -4))
(check-expect (bounce-bottom (make-ball LEF (- BOT 6) 3 7))
              (make-ball LEF (- BOT 1) 3 -7))
...
(check-expect (bounce-left (make-ball (+ LEF 1) TOP -2 4))
              (make-ball (+ LEF 1) TOP 2 4))
(check-expect (bounce-left (make-ball (+ LEF 2) TOP -3 7))
              (make-ball (+ LEF 1) TOP 3 7))
...
(check-expect (bounce-right (make-ball (- RIG 1) TOP 2 4))
              (make-ball (- RIG 1) TOP -2 4))
(check-expect (bounce-right (make-ball (- RIG 2) TOP 3 7))
              (make-ball (- RIG 1) TOP -3 7))
...
(check-expect (glide (make-ball (/ WIDTH 2) (/ HEIGHT 2) 2 4))
              (make-ball (+ (/ WIDTH 2) 2) (+ (/ HEIGHT 2) 4) 2 4))
(check-expect (glide (make-ball (/ WIDTH 2) (/ HEIGHT 2) 3 7))
              (make-ball (+ (/ WIDTH 2) 3) (+ (/ HEIGHT 2) 7) 3 7))
