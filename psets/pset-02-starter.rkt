...
;; produces true if the rating reflects a clear opinion either way
...
(@template (define (fn-for-rating r)
             (cond [(and (string? r) (string=? r "n/a")) (...)]
                   [else (... r)])))
