...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname pset-01-starter-2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
...
(foo 12 (+ 0 2))
(foo 12 2)
(if (and (> 12 LOWER) (< 12 UPPER)) (- 12 (* 2 2)) (+ 12 (* 2 3)))
(if (and (> 12 10) (< 12 UPPER)) (- 12 (* 2 2)) (+ 12 (* 2 3)))
(if (and #true (< 12 UPPER)) (- 12 (* 2 2)) (+ 12 (* 2 3)))
(if (and #true (< 12 20)) (- 12 (* 2 2)) (+ 12 (* 2 3)))
(if (and #true #true) (- 12 (* 2 2)) (+ 12 (* 2 3)))
...
;; takes two images and produces the image that has the greater height

(define ti (circle 30 "outline" "red")) ; circle of diameter 60
(define si (rectangle 20 40 "solid" "blue")) ; rectangle of height 40
(define ti2 (rectangle 20 60 "solid" "blue")) ; rectangle of height 60

(check-expect (taller-image si ti) ti)
(check-expect (taller-image ti si) ti)
(check-expect (taller-image ti ti2) ti2)
...
(define (taller-image i1 i2)
  (if (> (image-height i1) (image-height i2)) i1 i2)
)
