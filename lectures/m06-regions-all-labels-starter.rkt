...
;; produce list of all labels
; lor empty
(check-expect (all-labels--lor empty) empty)
; region singles
(check-expect (all-labels--region S1) (list "one"))
(check-expect (all-labels--region S2) (list "two"))
; region groups
(check-expect (all-labels--region G1) (list "one" "two" "three"))
(check-expect (all-labels--region G2) (list "one" "two" "three" "four"))
; lor at least 2 long
